...
def clean_date_of_birth(date):
    ...
    # Regex to match DD MMM YYYY or DD-MM-YYYY or DD/MM/YYYY
...
def process_image(image_path):
    ...
    final_name['পিতা']=None
    final_name['মাতা']=None
    final_name['স্বামী']=None
    final_name['স্ত্রী']=None
