...
img_path = "C:/Users/ishfaq.rahman/Desktop/NID Images/New Images/NID_2.png"
...
sharpened_image = cv2.filter2D(img_path, -1, kernel)

# Adjusting Brightness and Contrast
adjusted_image = cv2.convertScaleAbs(sharpened_image, alpha=1.2, beta=20) # alpha controls contrast, beta controls brightness
